...
const VariantCard = ( {variant} ) => (
  <div className={`p-1 md:pl-1 lg:pl-0 md:py-0 md:h-1/3 mx-auto mt-4 flex items-center rounded-full shadow-lg bg-${GetTypeStyle(variant.type_1)} pr-8 sm:pr-11 lg:pr-14 xl:pr-24 border`}>
    ...
    <div className="h-fit rounded-3xl flex px-2 md:pl-1 xl:pl-2 shadow-lg flex-grow justify-between border md:m-1">
...
const VariantDetails = ( {variant} ) => (
  <div className="px-1 text-xs sm:text-base md:text-lg lg:text-xl xl:text-3xl 2xl:text-4xl">
...
const VariantStats = ( {variant} ) => (
  <div className="text-xs lg:text-sm xl:text-base xl:w-auto 2xl:text-xl">
